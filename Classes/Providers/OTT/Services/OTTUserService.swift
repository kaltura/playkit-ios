...
public class OTTUserService: NSObject {
    ...
    static func login(baseURL: String, partnerId: Int64, username: String, password: String) -> KalturaRequestBuilder? {
    ...
    static func refreshSession(baseURL: String, refreshToken: String, ks: String) -> KalturaRequestBuilder? {
    ...
    static func anonymousLogin(baseURL: String, partnerId: Int64) -> KalturaRequestBuilder? {
